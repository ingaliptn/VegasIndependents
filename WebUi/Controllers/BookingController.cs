...
namespace WebUi.Controllers
{
    public class BookingController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.SiteTitle = texts.Where(z => z.Position == "Booking-SiteDescription").Select(z => z.Description)
                .FirstOrDefault();
            ViewBag.SiteDescription = texts.Where(z => z.Position == "Booking-Title").Select(z => z.Description)
                .FirstOrDefault();
        ...
        public async Task<IActionResult> Contact()
        {
            ...
            ViewBag.SiteTitle = texts.Where(z => z.Position == "Contact-SiteDescription").Select(z => z.Description)
                .FirstOrDefault();
            ViewBag.SiteDescription = texts.Where(z => z.Position == "Contact-Title").Select(z => z.Description)
                .FirstOrDefault();
